...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DPFSimulator.ascx.cs" Inherits="BmscWebSite2_Simulators.DPFSimulator.DPFSimulator" %>
...
<div class="simulator">
    ...
    <p>
        ...
        <asp:RequiredFieldValidator runat="server" ID="rfvMonto" ControlToValidate="txbMonto"
            ...
            SetFocusOnError="true" ForeColor="#95c11f" ValidationGroup="DPF"></asp:RequiredFieldValidator>
        <asp:RangeValidator runat="server" ID="rgvMonto" ControlToValidate="txbMonto"
            ...
            ForeColor="#95c11f" Type="Integer" MinimumValue="0" MaximumValue="9999999" ValidationGroup="DPF"></asp:RangeValidator>
    </p>
    ...
    <p>
        <asp:DropDownList runat="server" ID="ddlMoneda" CssClass="form" AppendDataBoundItems="true" ToolTip="Moneda">
            ...
            <asp:ListItem Text="Dólares" Value="1"></asp:ListItem>
        </asp:DropDownList>
    </p>
    <p>
        <asp:DropDownList runat="server" ID="ddlPlazo" CssClass="form" ToolTip="Plazo, en días" AppendDataBoundItems="true">
            <asp:ListItem Selected="True" Text="(Plazo, en días)" Value="-1"></asp:ListItem>
        </asp:DropDownList>
    ...
    <p class="buttonarea"><asp:LinkButton runat="server" ID="lnkConfirm" Text="simula tu interés" OnClick="lnkConfirm_Click" ValidationGroup="DPF"></asp:LinkButton></p>
